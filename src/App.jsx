...
const App = () => {
  ...
  // model configs
  const modelName = "yolo11n"; // "yolov8n";
  ...
  return (
    <div className="App">
      ...
      <div className="header">
        <h2 style={{fontSize: "24px", color: "#f77a06ff"}}>📟 Makers - Real-Time YOLOv11 Object Detection</h2>
        <p style={{ fontWeight: "bold"}}>
          YOLOv11 in TensorFlow.js — COCO-80 Classes
        </p>
        <p>
